...
Note: Read the requirements.txt to manually install the required modules
or do the following: pip install -r requirements.txt
"""
    ...
    def create_widgets(self) -> None:
        ...
        self.start_bg_file = ct.CTkImage(
            light_image=Image.open(
                os.path.join(App.basedir, "assets", "background.png")
            ),
        ...
        self.logo = ct.CTkImage(
            light_image=Image.open(
                os.path.join(App.basedir, "assets", "logo.png")
            ),
            dark_image=Image.open(
                os.path.join(App.basedir, "assets", "logo.png")
            ),
...
class CreditInputPage(ct.CTkFrame):
    ...
    def create_widgets(self) -> None:
        ...
        self.bg_file = ct.CTkImage(
            light_image=Image.open(
                os.path.join(App.basedir, "assets", "gradient.png")
            ),
            dark_image=Image.open(
                os.path.join(App.basedir, "assets", "gradient.png")
            ),
